...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="{{url('admin/check')}}" method="post">
    {{csrf_field()}}
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{captcha_src()}}" onclick="this.src='{{captcha_src()}}?+Math.random()'"  style='cursor:pointer;' title="看不清?点击换一张"></div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
